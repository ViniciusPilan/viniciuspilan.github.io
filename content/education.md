...
---
# Academic Background
Bachelor's Degree in Computer Science, Universidade Estadual Paulista Julio de Mesquita Filho - UNESP (Bauru) (2019-2022).
...
As a performance-based certification, it demonstrates the ability to work with core Kubernetes components, manage workloads, configure networking, perform cluster maintenance, and diagnose complex operational issues.
...
It demonstrates foundational knowledge of security principles across the cloud-native ecosystem, covering essential concepts such as container security, Kubernetes security fundamentals, supply chain security, risk management, and security best practices for modern cloud-native platforms.
...
* Security culture within cloud-native environments
